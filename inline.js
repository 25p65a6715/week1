...
document.getElementById('accountRegisterForm').addEventListener('submit', function(e) {
    ...
    sessionStorage.setItem('accUser', document.getElementById('regUser').value); // Save Username
...
document.getElementById('loginForm').addEventListener('submit', function(e) {
    ...
    if(enterUser === savedUser && enterPass === savedPass) {
        ...
        document.getElementById('resAccUser').textContent = sessionStorage.getItem('accUser'); // Display Username
...
document.getElementById('studentDetailsForm').addEventListener('submit', function(e) {
    ...
    document.getElementById('resYearSem').textContent = document.getElementById('yearSem').value; // Display Year & Sem
